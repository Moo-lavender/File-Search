...
public class PinyinUtil {
    ...
    public static String[] get(String name) {
        ...
        StringBuilder pinyinFrist = new StringBuilder(); //拼音首字母
            ...
            for(char c : name.toCharArray()) {
                try {
                    ...
                    if (pinyins == null || pinyins.length == 0) {
                        pinyin.append(c);
                        pinyinFrist.append(c);
                    }else {
                        //全拼：和——>he
                        pinyin.append(pinyins[0]);
                        //拼音首字母 ：和——>h
                        pinyinFrist.append(pinyins[0].charAt(0));
                    }
            ...
            result[1] = pinyinFrist.toString();
            return result;
    }

    /**
     * 和[he,huo,hu...] 长[chang,zhang]
     * @param name 文件名
     * @param fullSpell ture 表示全拼，false 取拼音首字母
     * @return 包含多音字的字符串组合
     */
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(get("中华人民a共12和国")));
